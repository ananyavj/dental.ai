      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        <div className="bg-white border-b border-dental-border px-5 py-3">
          ...
          <p className="text-xs text-dental-text-secondary">
            AI-generated phased treatment plan with correct sequencing logic
          </p>
        </div>
        ...
        <div className="flex-1 overflow-hidden flex">
          ...
          <div className="w-72 border-r border-dental-border overflow-y-auto p-4 space-y-3 bg-white">
            <h3 className="text-xs font-semibold text-dental-text uppercase tracking-wide">
              Patient Information
            </h3>
            ...
            {[
              ...
              <div key={key}>
                <label className="text-[10px] font-medium text-dental-text-secondary block mb-1">
                  {label}
                </label>
                <input
                  type={inputType || "text"}
            ...
            {[
              ...
              },
              {
                ...
                rows: 3,
                placeholder:
                  "e.g., Chronic periodontitis stage III, Caries tooth 26, Missing teeth 36, 46",
              },
              {
                key: "medicalHistory",
                label: "Medical History & Flags",
                rows: 2,
            ...
            <button
              onClick={handleBuild}
              disabled={loading || !form.chiefComplaint || !form.diagnoses}
            ...
            >
              {loading ? (
                ...
                <>
                  <ClipboardList size={14} /> Build Treatment Plan
                </>
              )}
            </button>
            ...
            {!plan && !loading && (
              <div className="flex items-center justify-center h-full text-dental-text-secondary">
                <div className="text-center">
                  ...
                  />
                  <p className="text-sm">
                    Fill the form to generate a phased treatment plan
                  </p>
                  <p className="text-xs mt-1">
                    Phase 1: Emergency → Phase 2: Perio → Phase 3: Restorative →
                    Phase 4: Maintenance
                  </p>
                </div>
              </div>
            ...
            {loading && (
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  <Loader2
                    size={32}
                    className="animate-spin text-dental-blue mx-auto mb-3"
                  />
              ...
              <div className="max-w-2xl mx-auto space-y-4 animate-slide-in">
                ...
                <div className="flex items-center gap-3">
                  <h2 className="text-sm font-bold text-dental-text flex-1">
                    {form.patientName
                      ? `Treatment Plan — ${form.patientName}`
                      : "Treatment Plan"}
                  </h2>
                ...
                {showPatientVersion ? (
                  ...
                  <>
                    {plan.phases?.map((phase, i) => (
                      <div
                        key={i}
                        className={`card p-4 border-l-4 ${PHASE_COLORS[i % PHASE_COLORS.length]}`}
                      >
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            <h3 className="text-sm font-bold text-dental-text">
                              Phase {phase.phase}: {phase.name}
                            </h3>
                            <p className="text-[10px] text-dental-text-secondary">
                              {phase.visits} visit
                              {phase.visits !== 1 ? "s" : ""} estimated
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="bg-dental-surface rounded-lg p-2.5">
                          <p className="text-[10px] text-dental-text-secondary italic">
                            {phase.rationale}
                          </p>
                        </div>
                      </div>
                    ...
                    {plan.maintenanceProtocol && (
                      <div className="card p-4 border-l-4 border-dental-blue">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h3 className="text-xs font-semibold text-dental-text">
                  ...
                  <div className="space-y-2">
                    {plan.phases?.map((phase, i) => (
                      <div key={i} className="flex items-center gap-3">
                        <span className="text-xs text-dental-text flex-1">
                          Phase {phase.phase}: {phase.name}
                        </span>
                        <input
                          type="text"
                    ...
                    <div className="flex items-center gap-3 pt-2 border-t border-dental-border">
                      <span className="text-xs font-bold text-dental-text flex-1">
                        Total Estimate
                      </span>
                      <input
                        type="text"
