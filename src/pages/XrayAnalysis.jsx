      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        ...
        <div className="bg-white border-b border-dental-border px-5 py-3">
          ...
          <p className="text-xs text-dental-text-secondary">
            Upload IOPA, OPG or CBCT — AI analysis with annotated findings
          </p>
        </div>
        ...
        <div className="flex-1 overflow-hidden flex">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {!image ? (
              ...
              >
                ...
                <Upload
                  size={32}
                  className={`mx-auto mb-3 ${isDragActive ? "text-dental-blue" : "text-dental-text-secondary"}`}
                />
                ...
                <p className="text-xs text-dental-text-secondary mt-1">
                  Supports JPEG, PNG, DICOM · Non-destructive analysis
                </p>
                  ...
                  <div className="bg-gray-800 px-4 py-2 flex items-center gap-4 flex-wrap">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        className="w-20 accent-dental-blue"
                      />
                    ...
                    <button
                      ...
                      className="ml-auto text-gray-400 hover:text-red-400 flex items-center gap-1 text-xs"
                    >
                      <X size={13} /> Remove
                    </button>
                  </div>
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex gap-2">
                          <span className="tag-pill">
                            {analysis.imagingType}
                          </span>
                          <span
                            className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                              analysis.quality === "Diagnostic"
                                ? "bg-green-100 text-green-700"
                                : analysis.quality === "Suboptimal"
                      ...
                      <p
                        className={`text-xs font-semibold mb-1 flex items-center gap-1 ${
                          analysis.urgency === "Immediate"
                            ? "text-red-600"
                            : analysis.urgency === "Within 1 week"
                              ? "text-amber-600"
                              : "text-green-600"
                        }`}
                      >
                        <AlertTriangle size={12} /> {analysis.urgency} action
                        required
                      </p>
                    </div>
                          ...
                          >
                            <div className="flex items-start gap-2">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                />
                                {selectedFinding?.id === f.id && (
                                  <p className="text-[11px] text-dental-text mt-2 border-t border-black/10 pt-2">
                                    {f.description}
                                  </p>
                                )}
                              </div>
          ...
          {analysis && (
            <div className="w-72 border-l border-dental-border bg-white overflow-y-auto p-4 space-y-4">
              <h3 className="text-xs font-bold text-dental-text uppercase tracking-wide">
                AI Interpretation
              </h3>
              ...
              <div>
                <h4 className="text-xs font-semibold text-dental-text mb-2">
                  Next Steps
                </h4>
                <ol className="space-y-1.5">
                  {analysis.nextSteps?.map((step, i) => (
                    ...
                    >
                      <span className="w-4 h-4 bg-dental-blue text-white rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5">
                        {i + 1}
                      </span>
                      {step}
                    </li>
                ...
                <div className="space-y-1">
                  {[
                    ...
                    <div key={label} className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-dental-text-secondary">
                        {label}
                      </span>
                    </div>
                  ))}
